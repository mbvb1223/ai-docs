...
| Billing | **Teams:** $150/seat (Premium) with PAYG available<br/>**Enterprise:** Contact Sales | PAYG | PAYG through AWS | PAYG through GCP | PAYG through Azure |
...
* **LLM Gateway**: A service that sits between Claude Code and the cloud provider to handle authentication and routing. Use this if you need centralized usage tracking across teams, custom rate limiting or budgets, or centralized authentication management.
