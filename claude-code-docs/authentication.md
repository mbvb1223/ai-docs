...
1. **Subscribe**: Subscribe to [Claude for Teams](https://claude.com/pricing#team-&-enterprise) or contact sales for [Claude for Enterprise](https://anthropic.com/contact-sales).

2. **Invite team members**: Invite team members from the admin dashboard.

3. **Install and log in**: Team members install Claude Code and log in with their Claude.ai accounts.
...
1. **Follow provider setup**: Follow the [Bedrock docs](/en/amazon-bedrock), [Vertex docs](/en/google-vertex-ai), or [Microsoft Foundry docs](/en/microsoft-foundry).

2. **Distribute configuration**: Distribute the environment variables and instructions for generating cloud credentials to your users. Read more about how to [manage configuration here](/en/settings).

3. **Install Claude Code**: Users can [install Claude Code](/en/setup#installation).
